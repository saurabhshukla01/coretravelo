...
<div id="main-wrapper">
   <div class="main-content">
      <section id="adddestination">
         ...
         <?php 
            $errormsg="";
            $place_name = $review_value = $place_charge = $place_image = $des_name = "";
            $valid_place_name = $valid_des_name = $valid_place_charge = $valid_review_value = $valid_place_charge ="false";
            ...
            if(isset($add_plc))
            {
               ...
               if($ext=="jpg" || $ext=="jpeg" || $ext=="png")
               {
                  ...
                  if(mysqli_query($link,"insert into places(place_uid,place_name,des_name,place_image,review_value,place_charge) values('$place_uid','$place_name','$des_name','$fnn','$review_value','$place_charge')"))
                  {
            ...
            <form method="POST" enctype="multipart/form-data" class="m-2">
               ...
               <div class="form-group">
                  ...
                  <select name="review_value" class="form-control">
                     <option disabled selected>Choose Review Here (Outoff 5 Star)</option>
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="place_charge" placeholder="Enter Place Entry Fee Charge">
               </div>
